    ...
    namespace LoadSystem
    {
        ...
        public class ResourceLoadManager
        {
            ...
            public static void clearDownLoadInfo()
            {
                ...
                Dictionary<string, Hashtable>.Enumerator it = _mDicLoadedRes.GetEnumerator();
                _removeResFromLoadedImmediate(_getStreamingAssetsNameByLoadStyle(eLoadResPath.RP_URL), typeof(TextAsset), eLoadResPath.RP_URL);
            }
            ...
            private static void _makeRefAssetsConfig(bool blocal = false)
            {
                ...
                removeRes(_getAssetsConfigByLoadStyle(blocal), typeof(TextAsset), loadrespath);
            ...
            /// <param name="type"></param>
            /// <param name="eloadResType"></param>
            internal static void _removeResFromLoadedImmediate(string respath, System.Type type, eLoadResPath eloadResType = eLoadResPath.RP_URL)
            {
                string skey = _getResKey(respath, type, eloadResType);
                if (_mDicLoadedRes.ContainsKey(skey))
                {
